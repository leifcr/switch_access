...
'				$("scrollToLatest").checked = isWrapEnabled;',
'			}',
'',
'			function toggleWrap() {',
...
'					<input type="checkbox" id="wrap" onclick="toggleWrap()" checked="checked" title="Enable / disable word wrap" /><label for="wrap" id="wrapLabel">Wrap</label>',
...
''
		...
		ConsoleAppender.prototype.create = function(inPage, container,
			...
			var wrapEnabled = this.defaults.wrapEnabled;
			...
			this.isWrapEnabled = function() { return wrapEnabled; };
			this.setWrapEnabled = function(wrapEnabledParam) {
				wrapEnabled = bool(wrapEnabledParam);
				if (consoleWindowExists()) {
					getConsoleWindow().setWrapEnabled(wrapEnabled);
				}
			};
			...
			var consoleWindowLoadHandler = function() {
				...
				win.setWrapEnabled(wrapEnabled);
