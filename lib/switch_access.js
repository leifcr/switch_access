...
(function() {
  ...
  SwitchAccess = (function() {
    ...
    SwitchAccess.prototype.destroy_elements = function(list) {
      ...
      while (i < list.length) {
        if (list[i].length > 1) {
          this.destroy_elements(list[i]);
        } else {
          this.destroy_element(list[i]);
        }
        i++;
      }
    };

    SwitchAccess.prototype.destroy_element = function(element) {
      this.log("destroy_element " + (element.uniqueDataAttr()), "trace");
      element.destroy();
    };
    ...
    */
    ...
    SwitchAccess.prototype.removeCallbacks = function() {
      ...
      return $(document).off("keypress.switch_access");
    };

    SwitchAccess.prototype.registerCallbacks = function() {
      var _this = this;
      this.log("registerCallbacks", "trace");
      $(document).on("keypress.switch_access", function(event) {
  ...
  SwitchAccessElement = (function() {
    ...
    SwitchAccessElement.prototype.destroy = function() {
      var children, jq_element, parent;
